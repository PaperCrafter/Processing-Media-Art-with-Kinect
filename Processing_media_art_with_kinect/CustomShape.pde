...
class CustomShape {
  ...
  CustomShape(float x, float y, float r, BodyType type) {
    ...
    EightNote = loadImage("R720x0-1.png");
    SisteenNote = loadImage("R720x0-2.png");
    DoubleFour = loadImage("R720x0.png");
    TrebleClef = loadImage("R720x0-1.png");
  ...
  void display() {
    ...
    if (r == -1) {
      ...
      if(toxiPoly.getNumPoints() == 3){
         image(DoubleFour, 0,0);
      }
      
      if(toxiPoly.getNumPoints() == 4){
        image(SisteenNote, 0,0);
        
      }
      
      
      if(toxiPoly.getNumPoints() ==  5){
        image(TrebleClef, 0,0);
      };
    } 
